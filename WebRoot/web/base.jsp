...
-->
	...
	<body>
		<form  action="<%=basePath%>servlet/RestServlet" method="post">
												...
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td width="94%" valign="bottom" class="STYLE1">
															...
															<select name="selectBase" id="selectBase">
...
>
							<tr>
								...
								<td width="15%" height="20" bgcolor="d3eaef" class="STYLE6">
									<div align="center">
										<span class="STYLE10">库存商品名称</span>
									</div>
								</td>
								<td width="14%" height="20" bgcolor="d3eaef" class="STYLE6">
									<div align="center">
										<span class="STYLE10">库存数量</span>
									</div>
								</td>
								...
								<td width="27%" height="20" bgcolor="d3eaef" class="STYLE6">
									<div align="center">
										<span class="STYLE10">商品详细描述</span>
									</div>
								</td>
							...
							<tr>
								...
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">
										<span class="STYLE19"><%=listProduct.get(i).getProductName()%></span>
									</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">
										<span class="STYLE19"><%=listProduct.get(i).getTradeMark()%></span>
									</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">
										<span class="STYLE19"><%=listProduct.get(i).getDetailInfo()%></span>
									</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">
