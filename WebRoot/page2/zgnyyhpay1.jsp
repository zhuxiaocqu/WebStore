    		...
    		<table width="700" height="200" border="1" align="center" rules="none" style="margin-top:120">
				 <tr>
				 	<td style="padding-left:100">
				 		...
				 		你选择的是通过中国农业银行进行网上支付，只有在网上支付成功后，我们才会为您发货。<br><br>
				 		请立即支付:<b><input type="button" name="1" id="1" value="中国农业银行网上支付"style="background-color:#FFCC33;width:120px;height:40px;cursor:pointer"class="btn_grey"/></b>
				 	</td>
				 </tr>				
    		</table>
   			</form>
