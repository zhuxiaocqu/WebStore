      ...
      <form action="" method="post">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="25%"><img src="images/zgnyyh.JPG" width="192" height="38"></td>
            <td width="28%">储蓄卡  <img src="images/kjfs.JPG" width="86" height="28"></td>
            <td width="30%" class="payed">支付：</td>
            </tr>
          <tr>
