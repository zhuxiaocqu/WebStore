 ...
 <table width="790" height="236"  border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
    <td height="182" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="727" height="300"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="lightgrey" bgcolor="#F9F9F9" rules="none" style="margin-top:100">
        <tr>
          <td width="723" height="200"style="padding-left:100"> 订单号：<font color="red">填写订单号</font>，您需要支付：<font color="red">支付金额</font><br>
            <br>
            你选择的是通过支付宝支付平台进行网上支付，只有在网上支付成功后，我们才会为您发货。<br>
            <br>
            请立即支付：<a href="https://www.alipay.com/"><img src="images/alipay_bwrx.gif" border="0"></a></td>
        </tr>
      </table>
      <!--支付宝-->
      <p></p>
