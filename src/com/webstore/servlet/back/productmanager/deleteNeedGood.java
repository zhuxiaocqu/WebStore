...
public class deleteNeedGood extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public deleteNeedGood() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int needId = Integer.valueOf(request.getParameter("goodNeedId"));
		
		System.out.println("获取到的id"+needId);
		try {

			RestDAO restDao = new RestDAO();

			restDao.delete(needId);
